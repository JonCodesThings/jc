...
%token STRUCT_TYPE_KEYWORD ALIAS_TYPE_KEYWORD TYPEDEF_TYPE_KEYWORD SEMICOLON_TYPE_KEYWORD IDENTIFIER_TYPE_KEYWORD LB NONE
...
any: defs | SEMICOLON_TYPE_KEYWORD | IDENTIFIER_TYPE_KEYWORD | LB | NONE;

stuff: any | stuff any

defs: struct_def | alias_def | typedef_def

struct_def: STRUCT_TYPE_KEYWORD IDENTIFIER_TYPE_KEYWORD
{
    registry->AddBlankStructType(identifier_stack.back());
};

struct_decl: STRUCT_TYPE_KEYWORD IDENTIFIER_TYPE_KEYWORD SEMICOLON_TYPE_KEYWORD
{}
